...
namespace MSM.Model.InputSimulation
{
    public class SendInputWrapper
    {
        ...
        //TODO: Poner delay
        private void SendScanCode(Key key)
        {
            ...
            Input.U.ki.wScan = (short)MapVirtualKey((uint)KeyInterop.VirtualKeyFromKey(key), MAPVK_VK_TO_VSC);
        ...
        private void SendKeyUp(Key key)
        {
            ...
            Input.type = 1; // 1 = Keyboard Input
            //Input.U.ki.wVk = (VirtualKeyShort)KeyInterop.VirtualKeyFromKey(key);
            Input.U.ki.wScan = (short)MapVirtualKey((uint)KeyInterop.VirtualKeyFromKey(key), MAPVK_VK_TO_VSC);
        ...
        #region "Interop required structs and stuff
